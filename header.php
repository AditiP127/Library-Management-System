                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="return_book.php"><i class="fa fa-bar-chart-o"></i> Return Book <span class="fa fa-chevron-down"></span></a>
							...
							<li><a href="send_notification_student.php"><i class="fa fa-mail-forward"></i> Sent Message to Student<span class="fa fa-chevron-down"></span></a>
