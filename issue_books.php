                            ...
                            <div class="x_content">
								 ...
								 <?php
								    ...
								    if(isset($_POST["submit1"]))
									{
										...
										<tr>
											...
											name="submit2" class="form-control btn btn-default" style="background-color: green; color: white"></td> 
									    </tr>
								 ...
								 <?php
									if(isset($_POST["submit2"]))
									{
										...
										{
											mysqli_query($link,"insert into issue_books values('','$_SESSION[enrollment]','$_POST[studentname]','$_POST[studentsem]','$_POST[studentcontact]','$_POST[studentemail]','$_POST[bookname]','$_POST[bookissuedate]','','$_SESSION[username]')");
